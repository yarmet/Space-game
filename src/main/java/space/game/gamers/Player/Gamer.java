...
public class Gamer extends SpaceShip {
   ...
   private void checkMove() {
      if (this.x > (double)(space.game.game.Display.BATTLEFIELD.width - this.image.getWidth())) {
         this.x = (double)(space.game.game.Display.BATTLEFIELD.width - this.image.getWidth());
      }

      if (this.x < (double) space.game.game.Display.BATTLEFIELD.x) {
         this.x = (double) space.game.game.Display.BATTLEFIELD.x;
      }

      if (this.y > (double)(space.game.game.Display.BATTLEFIELD.height - this.image.getHeight())) {
         this.y = (double)(space.game.game.Display.BATTLEFIELD.height - this.image.getHeight());
      }

      if (this.y < (double) space.game.game.Display.BATTLEFIELD.y) {
         this.y = (double) space.game.game.Display.BATTLEFIELD.y;
      }
